...
public class PageInterceptor implements Interceptor {
	...
	private String getPageSql(String originalSql, Page page) {
		return "select * from (select rownum rownum_, a.* from ("
				+ originalSql + ") a)  where rownum_ >"+ (page.getpageSize() * (page.getCurrentPage() - 1))
				+" and rownum_ <="+(page.getpageSize() * (page.getCurrentPage()));
	}
