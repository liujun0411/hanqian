...
<script type="text/javascript" src="manager/js/ckeditor/ckeditor.js"></script>
	...
	<form id="infoForm" name="infoForm" action="info_creatInfo.action" method="post"  enctype="multipart/form-data">
		<table id="tb_info" width="90%" align="center" border="0"
			...
			class="left"
				--%><td >标题:</td>
				<td align="left"><input type="text" id="txtTitle" class="text" name="txtTitle"  style="width: 400px;" align="left"/> 
				</td>
			</tr>
		</table>
	    ...
	    <div align="right" style="padding: 17px ">
                <input type="button" value="确定" id="submitAll" > 
			    <input type="button" id="return" onclick="javascript:history.back(-1); " value="返回">
	    </div>
		...
		function submitForm(){
			if(validContent()){
			     $.ajax({ 
		               ...
		               url:'info_creatInfo.action',//用于文件上传的服务器端请求地址  
