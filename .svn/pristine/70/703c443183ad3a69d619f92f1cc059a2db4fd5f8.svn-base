$(function () {
    ...
    $( "#tabs2" ).on( "click",'span.ui-icon-close', function() {       
        //start add by lg 2013-11-26
    	var selId =  $( this ).closest( "li" ).attr( "aria-controls" ).replace("tabs-","");
    	var prevId = $( this ).closest( "li" ).prev().attr( "aria-controls" ).replace("tabs-","");
    	if($( this ).closest( "li" ).next().length==0){
        	$('#'+prevId).click();
    	}else{
    		var nextId = $( this ).closest( "li" ).next().attr( "aria-controls" ).replace("tabs-","");
    		$('#'+nextId).click();
    	}
//   	if($( this ).closest( "li" ).next().length==0){
//       	$('#'+prevId).parent().addClass("active");
//   	}
//    	$('#'+selId).parent().removeClass("active");
    	//end add by lg 2013-11-26
