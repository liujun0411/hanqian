...
<%--	if($('#mark').val()=="edit"){--%>
<%--		alert('success');--%>
<%--		document.saveForm.action = "maintenance_updateMaintenance.action";--%>
<%--	}--%>
	document.saveForm.submit();
}
	...
	<body>
		<div id="admin_nr_jbxx">
			<form action="maintenance_insertMaintenance.action" method="post"
				...
				<input type="hidden" value="${dbMaintenance.dbEquipList.equipId }" name="dbEquipList.EquipId" />
				<table width="970" border="0" cellspacing="1" class="gai_left_duiqi">
					...
					<tr class=" biaog_kan2 biaog_zt2 admin_bgclor_fff">
						...
						<td class="admin_bgclor_f1f">
							<input type="text" name="equipTypeId" id="equipTypeId" readonly="readonly" onclick="creatediv(this);"/>
							<input type="hidden" name="dbEquipList.dbEquipType.equipTypeId" id="eqTypeId"/>
						</td>
						<td class="admin_bgclor_e3f">
						...
						<td class="admin_bgclor_f1f">
							<select
								style="width:150px;" id="equipId" name="equipId">
					...
					<tr class=" biaog_kan2 biaog_zt2 admin_bgclor_fff">
						...
						<td class="admin_bgclor_f1f">
							<input name="serviceman" type="text"
								id="serviceman"  />
						</td>
						<td class="admin_bgclor_e3f ">
							维护类型
					...
					<tr class=" biaog_kan2 biaog_zt2 admin_bgclor_f1f">
						...
						<td class="admin_bgclor_f1f">
							<input name="pact" type="text" id="pact" />
						</td>
						<td class="admin_bgclor_e3f ">
							维护日期
							<span class="admin_clor_f00">*</span>
						...
						<td class="admin_bgclor_f1f">
							<input type="text" readonly="readonly" class="Wdate"
								name="servicetime" id="sDate1" size="14"
								style="width: 148px"
