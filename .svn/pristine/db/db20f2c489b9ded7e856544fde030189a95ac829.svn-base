...
function tipsWindown(title,content,width,height,drag,time,showbg,cssName,showPos,backcall) {
	...
	if ( _version == 6.0 ) {
		...
		if(showPos==1){
			$("#windown-box").css({left:"50%",top:"10%",marginLeft:-((parseInt(width)+32)/2)+"px",zIndex: "999999"});
		}else{
