...
<%--	  		});--%>
 ...
 ${textHtml} 
			...
			<div class="admin_nr_rightg" style="position:fixed; absolute; z-index: 999; " border="1px">
		...
		<div id="admin_nr_rightg">
			...
			<div style=" border:0px solid red;" class="shishijiankong_zxq">
				 ...
				 <div class="flashOverFlow" style="margin-top: 140px;">
					<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
						codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0"
						width="1000" height="500">
						<param name="movie" value="manager/images/control/flashNew/jsjcheku.swf" /> 
						<param name="quality" value="high"/>
						<param name="wmode" value="transparent"/>
						<embed src="manager/images/control/flashNew/jsjcheku.swf" wmode="transparent" quality="high"
