...
//为集水井 设备加载div状态
 ...
 ${textHtml} 
		...
		<div id="admin_nr_rightg">
			...
			<!-- 图片区 -->
			<div style=" border:0px solid red; position: absolute;" class="shishijiankong_zxq">
			
				 <div class="flashOverFlow" style="margin-top: 150px; margin-left: 50px;">
					
					<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
						codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0"
						width="1000" height="500">
						<param name="movie" value="manager/images/control/flashNew/jsj/${sessionScope.currentHospCode }/jsj${groupId}.swf" /> 
						<param name="quality" value="high"/>
						<param name="wmode" value="transparent"/>
						<embed src="manager/images/control/flashNew/jsj/${sessionScope.currentHospCode }/jsj${groupId}.swf" wmode="transparent" quality="high"
							pluginspage=" http://www.macromedia.com/shockwave/download/index.cgi?P1_Pr od_Version=ShockwaveFlash"
							type="application/x-shockwave-flash" width="1000" height="500">
						</embed>
					</object>
				</div>
			</div>
